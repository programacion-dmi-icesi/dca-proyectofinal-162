...
/**
 * 
 * Esta es la clase base de las especies del ecosistema contempla los metodos
 * necesarios para la construccion de cada una *
 * 
 * @author Jamoncada
 *
 */
...
public abstract class EspecieAbstracta implements Runnable {
	...
	/**
	 * 
	 * Metodo encargado de determinar el estado de una especie concreta, los
	 * estados posibles son:
	 * 
	 * NORMAL, ENFERMO, ENVENENADO, EXTASIS y MUERTO
	 * 
	 * @param estado
	 *            es un entero que debe corresponder a las constantes estaticas
	 *            disponibles en la clase.
	 * @throws Exception
	 *             Se lanza cuando no se esta usando un numero de entero valido.
	 */
	...
	/**
	 * Método encargadado de recibir el daño ocasionado por el ataque de otra
	 * especie abstracta el método deberá validar su posicion respecto a la
	 * otra especie para saber si se lastima o no.
	 * 
	 * @param lastimador
	 *            quien hace daño a la especie actual
	 * @return true si pudo hacer daño y false si no puedo dañar a la especie
	 *         actual
	 */
